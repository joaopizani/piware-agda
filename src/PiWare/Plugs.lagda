...
open import PiWare.Circuit Gt using (ℂσ; Mkℂ; _named_)
...
\AgdaTarget{pSwap}
\begin{code}
pSwap : ∀ {α i β j} ⦃ _ : ⇓W⇑ α {i} ⦄ ⦃ _ : ⇓W⇑ β {j} ⦄ → ℂσ (α × β) (β × α)
...
\AgdaTarget{pALR}
\begin{code}
pALR : ∀ {α i β j γ k} ⦃ _ : ⇓W⇑ α {i} ⦄ ⦃ _ : ⇓W⇑ β {j} ⦄ ⦃ _ : ⇓W⇑ γ {k} ⦄ → ℂσ ((α × β) × γ) (α × (β × γ))
...
\AgdaTarget{pARL}
\begin{code}
pARL : ∀ {α i β j γ k} ⦃ _ : ⇓W⇑ α {i} ⦄ ⦃ _ : ⇓W⇑ β {j} ⦄ ⦃ _ : ⇓W⇑ γ {k} ⦄ → ℂσ (α × (β × γ)) ((α × β) × γ)
...
\AgdaTarget{pHead}
\begin{code}
pHead : ∀ {α i n} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ (Vec α (suc n)) α
...
\AgdaTarget{pUncons}
\begin{code}
pUncons : ∀ {α i n} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ (Vec α (suc n)) (α × Vec α n)
...
\AgdaTarget{pCons}
\begin{code}
pCons : ∀ {α i n} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ (α × Vec α n) (Vec α (suc n))
...
\begin{code}
pSingletonIn : ∀ {α i} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ α (Vec α 1)
...
\begin{code}
pSingletonOut : ∀ {α i} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ (Vec α 1) α
...
\AgdaTarget{pVecHalt}
\begin{code}
pVecHalf : ∀ {α i n} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ (Vec α (2 * suc n)) (Vec α (suc n) × Vec α (suc n))
pVecHalf {_} {i} {m} ⦃ sα ⦄ =
...
\begin{code}
pVecHalfPow : ∀ {α i n} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ (Vec α (2 ^ suc n)) (Vec α (2 ^ n) × Vec α (2 ^ n))
...
\AgdaTarget{pForkVec}
\begin{code}
pForkVec : ∀ {α i n} ⦃ _ : ⇓W⇑ α {i} ⦄ → ℂσ α (Vec α n)
...
\AgdaTarget{pFst}
\begin{code}
pFst : ∀ {α i β j} ⦃ _ : ⇓W⇑ α {i} ⦄ ⦃ _ : ⇓W⇑ β {j} ⦄ → ℂσ (α × β) α
...
\AgdaTarget{pSnd}
\begin{code}
pSnd : ∀ {α i β j} ⦃ _ : ⇓W⇑ α {i} ⦄ ⦃ _ : ⇓W⇑ β {j} ⦄ → ℂσ (α × β) β
