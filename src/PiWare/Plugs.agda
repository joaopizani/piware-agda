...
pSingletonIn {_} {#α} ⦃ sα ⦄ = Mkℂ ⦃ sα ⦄ ⦃ ⇓𝕎⇑-Vec {n = 1} ⦃ sα ⦄ ⦄  c'
    where c' : ℂ' Atom #α (1 * #α)
          c' rewrite (proj₂ +-identity) #α = pid'
...
pSingletonOut {_} {#α} ⦃ sα ⦄ = Mkℂ ⦃ ⇓𝕎⇑-Vec {n = 1} ⦃ sα ⦄ ⦄ ⦃ sα ⦄  c'
    where c' : ℂ' Atom (1 * #α) #α
          c' rewrite (proj₂ +-identity) #α = pid'
...
pFork× {_} {#α} ⦃ sα ⦄ = Mkℂ ⦃ sα ⦄ ⦃ ⇓𝕎⇑-× ⦃ sα ⦄ ⦃ sα ⦄ ⦄  c'
    where c' : ℂ' Atom #α (#α + #α)
          c' rewrite sym $ cong (_+_ #α) ((proj₂ +-identity) #α) = pFork' {Atom} {2} {#α}
