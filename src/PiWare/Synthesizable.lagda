...
-- ⇓𝕎⇑-Vec {α} {i} {n} sα = ⇓𝕎⇑[ down , up ][ down-up , up-down ]
...
--           down-up : (as : Vec α n) → up (down as) ≡ as
--           down-up as = ?

--           up-down : (w : 𝕎 (n * i)) → down (up w) ≡ w
--           up-down w = ?
-- \end{code}
-- %</Synth-Vec>
...
-- ⇓𝕎⇑-⊎' {α} {i} {β} {j} n₁ n₂ p sα sβ = ⇓𝕎⇑[ down , up ][ down-up , up-down ]
...
--           down-up : (ab : α ⊎ β) → up (down ab) ≡ ab
--           down-up ab = ?

--           up-down : (w : 𝕎 (suc (i ⊔ j))) → down (up w) ≡ w
--           up-down w = ?
-- \end{code}
-- %</Synth-Sum-param>
