...
%<*par>
\begin{code}
_||_ : ∀ {α i γ k β j δ l}  → ⦃ sα : ⇓W⇑ α {i} ⦄ ⦃ sγ : ⇓W⇑ γ {k} ⦄
                            → ⦃ sβ : ⇓W⇑ β {j} ⦄ ⦃ sδ : ⇓W⇑ δ {l} ⦄
...
_comb⟫_ {i = i} {j = j} {k = k} {c₁ = Mkℂ c₁'} {c₂ = Mkℂ c₂'} p₁ p₂ =
    _comb⟫'_ {i} {j} {k} {c₁'} {c₂'} p₁ p₂
\end{code}
%</lemma-comb-seq>

%<*lemma-comb-par>
\begin{code}
_comb|_ : ∀ {α i γ k β j δ l}
...
comb|+ : ∀ {α i β j γ k} → ⦃ sα : ⇓W⇑ α {i} ⦄ ⦃ sβ : ⇓W⇑ β {j} ⦄ ⦃ sγ : ⇓W⇑ γ {k} ⦄
       → {c₁ : ℂ α γ {i} {k}} {c₂ : ℂ β γ {j} {k}} {n₁ n₂ p : Atom#} {diff : n₁ ≢ n₂}
       → comb c₁ → comb c₂ → comb (|+ n₁ n₂ p {diff} c₁ c₂)
comb|+ {i = i} {j = j} {k = k} {c₁ = Mkℂ c₁'} {c₂ = Mkℂ c₂'} p₁ p₂ =
    _comb|+'_ {i} {j} {k} {c₁'} {c₂'} p₁ p₂
\end{code}
%</lemma-comb-sum>
